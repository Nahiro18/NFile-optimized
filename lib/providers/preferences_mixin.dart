...
mixin PreferencesMixin on ChangeNotifier {
  ...
  bool _showFolderFileCount = true;
  ...
  bool _showFolderContentsCount = true;
  bool _showFolderSizes = true;
  bool _adaptiveMultiLineNames = true;
  bool _hideActionMenuButtons = false;
  String _trailingInfoType = 'default';
  bool _hideActionText = false;
  bool _rememberLastFolder = false;
  bool _useMaterialIcons = false;
  String _exitOption = 'default';
  String get currentPath;
  List<FileItemModel> get currentFiles;
  FolderTabModel get activeTab;
  List<FolderTabModel> get tabs;
